...
@Tag(name = "6. Admin - User Management", description = "APIs for managing system users (Admin only)")
@RestController
...
public class AdminUserController {
    ...
    public ApiResponse<AdminUserResponse> createUser(@Valid @RequestBody
    ...
    @PutMapping("/{id}")
    public ApiResponse<AdminUserResponse> updateUser(@PathVariable
    Long id,
            @Valid @RequestBody
    ...
    @DeleteMapping("/{id}")
    public ApiResponse<Void> deactivateUser(@PathVariable
    Long id) {
    ...
    public ApiResponse<Void> resetPassword(@PathVariable
    Long id) {
